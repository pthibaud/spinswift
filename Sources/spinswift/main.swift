...
let crystalStructure = generateCrystalStructure(
    unitCellAtoms: unitCellAtoms, supercell: supercellDimensions, latticeConstant: 0.35,
    initialParam: initials)

//Define boundary conditions
let Boundaries = BoundaryConditions(boxSize: 0.35 * Vector3(3, 3, 3), periodicity: "on")
