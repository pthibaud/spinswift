...
public class Matrix3: Codable {
    ...
    func diagonalPart() -> Matrix3 {
        return Matrix3(
            xx: self.xx, xy: 0, xz: 0, yx: 0, yy: self.yy, yz: 0, zx: 0, zy: 0, zz: self.zz)
    }
    ...
    // compute the cofactor matrix for a 3x3 Matrix
    ...
    func inverse() -> Matrix3 {
        guard self.determinant() != 0 else {
            print("Matrix is not invertible!")
            exit(-1)
        }
        return (1 / self.determinant()) * self.adjoint()
    }
    ...
    public static func + (a: Matrix3, b: Matrix3) -> Matrix3 {
        return Matrix3(
            xx: (a.xx) + (b.xx), xy: (a.xy) + (b.xy), xz: (a.xz) + (b.xz), yx: (a.yx) + (b.yx),
            yy: (a.yy) + (b.yy), yz: (a.yz) + (b.yz), zx: (a.zx) + (b.zx), zy: (a.zy) + (b.zy),
            zz: (a.zz) + (b.zz))
    }
    ...
    public static func * (a: Double, b: Matrix3) -> Matrix3 {
        return Matrix3(
            xx: a * (b.xx), xy: a * (b.xy), xz: a * (b.xz), yx: a * (b.yx), yy: a * (b.yy),
            yz: a * (b.yz), zx: a * (b.zx), zy: a * (b.zy), zz: a * (b.zz))
    }
    ...
    public static func == (a: Matrix3, b: Matrix3) -> Bool {
        return (a.xx == b.xx) && (a.xy == b.xy) && (a.xz == b.xz) && (a.yx == b.yx)
            && (a.yy == b.yy) && (a.yz == b.yz) && (a.zx == b.zx) && (a.zy == b.zy)
            && (a.zz == b.zz)
    }
