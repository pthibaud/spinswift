...
public let mRy: ConversionFactors = ConversionFactors(value: 1.0/13.605693009, description: "milliRydberg", units: "[mRy/meV]")
public let erg: ConversionFactors = ConversionFactors(value: 6.2415091*1e14, description: "erg", units: "[erg/meV]")
public let Joule: ConversionFactors = ConversionFactors(value: 1e-3/elementary_charge.value, description:"Joule", units: "[J/meV]")
